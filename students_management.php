...
function initSidebar() {
    ...
    // فتح القائمة عند مرور الماوس (لشاشات الكبيرة فقط)
    ...
    // إغلاق القائمة عند إبعاد الماوس (لشاشات الكبيرة فقط)
...
// تحميل الرسوم الدراسية - الإصدار المحسن والأسرع
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
            try {
                ...
                console.log('تم تحميل الرسوم من الخادم:', fees);
