...
CREATE TABLE `residential_areas` (
  ...
  `area_type` enum('main','sub') COLLATE utf8_unicode_ci DEFAULT 'main',
...
INSERT INTO `cash_box` (`id`, `current_balance`) VALUES (1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cash_box_transactions`
--
...
--
-- Constraints for table `cash_box_transactions`
--
ALTER TABLE `cash_box_transactions`
  ADD CONSTRAINT `cash_box_transactions_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`);
