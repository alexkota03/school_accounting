...
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" id="studentForm">
								...
								<div id="studentAreaPriceDisplay" class="area-price-display">
									<div class="price-box">
    ...
    <script>
// =============================================
// نظام إدارة الطلاب - JavaScript الكامل (محدث بدون area_code)
// =============================================
...
// =============================================
// نظام المناطق السكنية الهرمي (محدث بدون area_code)
// =============================================
...
function initResidentialAreas() {
    ...
    console.log('mainAreaSelect:', mainAreaSelect);
    console.log('subAreaSelect:', subAreaSelect);
    ...
    if (subAreaSelect) {
        ...
        console.error('لم يتم العثور على عنصر اختيار المنطقة الفرعية');
    }
    ...
    <?php else: ?>
    console.log('لا توجد بيانات منطقة للتحميل (وضع إضافة جديد)');
    <?php endif; ?>
}
...
function displayAvailableMainAreas() {
    ...
    const availableAreas = options.length - 1; // ناقص option الافتراضي
    ...
    if (availableAreas <= 0) {
        ...
        console.log('قائمة المناطق الرئيسية:');
        options.forEach((option, index) => {
            if (option.value) {
                console.log(`- ${option.textContent} (ID: ${option.value})`);
            }
        });
    }
}
...
function createFeeElement(fee) {
    ...
    const color = isMandatory ? '#e74c3c' : '#27ae60';
...
console.log('تم تحميل نظام إدارة الطلاب بالكامل (بدون area_code)');
